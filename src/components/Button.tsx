...
export default function Button({ children, variant, className, ...rest}: ButtonProps) {
    const base: string = 'text-white font-poppins px-5 lg:px-7 py-2 rounded-full shadow-lg hover:cursor-pointer active:scale-95 hover:scale-95 transition-all duration-300'
    const variants = {
        primary: "bg-[#00ADB5]",
