  ...
  return (
    <section className="px-8 py-30 bg-projects">
      ...
      <figure className="flex items-center gap-10">
        <Project className="p-8">
          <img src={P_1} alt="project 1" className="hover:scale-95 hover:cursor-pointer transition-all duration-300"/>
        </Project>

        <Project>
          <img src={P_2} alt="project 2" className="hover:scale-95 hover:cursor-pointer transition-all duration-300"/>
        </Project>

        <Project>
          <img src={P_3} alt="project 3" className="hover:scale-95 hover:cursor-pointer transition-all duration-300"/>
        </Project>
