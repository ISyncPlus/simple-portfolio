...
export default function Contact() {
  return (
    <section id="contact" className="flex flex-col lg:flex-row items-center px-8 py-30">
      ...
      <form className='md:flex-1 w-screen pl-8 pr-10 md:pr-10'>
        ...
        <section className="flex flex-col md:flex-row md:items-center gap-3 mb-3">
          ...
          <div>
            ...
            <input type="text" name="name" placeholder='Name' className="bg-[#393E4680] px-5 py-3 rounded-2xl font-bold w-full"/>
          </div>

          <div>
            <label htmlFor="email" className="block mb-3">Your Email</label>
            <input type="email" name="email" placeholder='Email' className='bg-[#393E4680] px-5 py-3 rounded-2xl font-bold w-full' />
          </div>
        ...
        <Button variant="primary" type="submit" className="flex justify-center items-center gap-3 w-full">Send Message <FaTelegramPlane className="inline"/></Button>
