  ...
  return (
    ...
    px-10 py-30">
      <article className="flex flex-col flex-1 relative">
        ...
        <p className="text-sm">Lorem ipsum dolor, sit amet consectetur adipisicing elit. Aspernatur corrupti nam voluptas ut eius nisi placeat, commodi accusantium vitae dolorem ipsum provident veritatis beatae repellat, ipsa eligendi. Suscipit, sapiente rem.
      ...
      <figure className="flex-1 relative flex justify-end">
        <img src={AboutDoodle} alt="doodle" className="w-[90%]"/>
        <img src={AboutFigure} alt="figure" className="absolute top-25 right-0 w-[40%] sm:w-[50%] lg:w-[70%]" />
